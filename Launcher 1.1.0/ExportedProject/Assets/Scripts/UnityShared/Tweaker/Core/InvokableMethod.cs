...
namespace Tweaker.Core
{
	public class InvokableMethod : BaseInvokable
	{
		...
		public InvokableMethod(InvokableInfo info, MethodInfo methodInfo, WeakReference instance)
			: base(info, methodInfo.ReflectedType.Assembly, instance, methodInfo.IsPublic, methodInfo.GetParameters())
		{
		...
		public InvokableMethod(InvokableInfo info, Delegate methodDelegate)
			: base(info, methodDelegate.Method.ReflectedType.Assembly, (methodDelegate.Target == null) ? null : new WeakReference(methodDelegate.Target), methodDelegate.Method.IsPublic, methodDelegate.Method.GetParameters())
		{
