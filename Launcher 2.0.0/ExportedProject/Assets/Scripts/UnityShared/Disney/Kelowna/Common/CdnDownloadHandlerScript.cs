...
namespace Disney.Kelowna.Common
{
	internal class CdnDownloadHandlerScript : DownloadHandlerScript
	{
		...
		{
			closeDownloadFile();
			downloadFileStream = new FileStream(downloadFilename, FileMode.Create, FileAccess.Write, FileShare.None, 4096, FileOptions.WriteThrough | FileOptions.SequentialScan);
		}
