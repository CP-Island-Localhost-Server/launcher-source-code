...
namespace Disney.Kelowna.Common.Tests
{
	...
	{
		public CacheableType<bool> SfxEnabled { get; set; }

		public CacheableType<bool> MusicEnabled { get; set; }

		public CacheableType<float> SfxVolume { get; set; }

		public CacheableType<float> MusicVolume { get; set; }

		public CacheableType<string> SavedLanguage { get; set; }

		public DevCacheableType<Disney.Kelowna.Common.Environment.Environment> DevelopmentEnvironment { get; set; }
