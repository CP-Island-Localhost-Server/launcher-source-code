...
namespace DevonLocalization.Core
{
	...
	{
		private static string[] LANGUAGES = new string[6] { "none", "en_US", "pt_BR", "fr_FR", "es_LA", "oversized" };

		private static string[] ISO639_LANGUAGE_STRINGS = new string[6] { "en-US", "en-US", "pt-BR", "fr-FR", "es-LA", "en-US" };

		private static string[] CULTURE_LANGUAGE_STRINGS = new string[6] { "en-US", "en-US", "pt-BR", "fr-FR", "es-AR", "en-US" };

		private static string[] OneID_LANGUAGE_STRINGS = new string[6] { "en-US", "en-US", "pt-BR", "fr-FR", "es-LA", "en-US" };
