...
namespace Newtonsoft.Json.Linq
{
	public abstract class JContainer : JToken, IList<JToken>, ICollection<JToken>, IEnumerable<JToken>, ITypedList, IBindingList, IList, ICollection, IEnumerable
	{
		...
		{
			Newtonsoft.Json.ObservableSupport.AddingNewEventHandler addingNew = this.AddingNew;
			if (addingNew != null)
			{
				addingNew(this, e);
			}
		...
		{
			ICustomTypeDescriptor customTypeDescriptor = First as ICustomTypeDescriptor;
