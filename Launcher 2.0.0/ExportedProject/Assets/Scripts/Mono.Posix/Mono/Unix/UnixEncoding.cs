...
namespace Mono.Unix
{
	...
	public class UnixEncoding : Encoding
	{
		...
		public override int GetBytes(string s, int charIndex, int charCount, byte[] bytes, int byteIndex)
		{
			...
			while (charCount > 0)
			{
				...
				if (num3 < 2048)
				{
					...
					bytes[num2++] = (byte)(0xC0u | (num3 >> 6));
					bytes[num2++] = (byte)(0x80u | (num3 & 0x3Fu));
					continue;
				}
				if (num3 < 65536)
				{
					...
					bytes[num2++] = (byte)(0xE0u | (num3 >> 12));
					bytes[num2++] = (byte)(0x80u | ((num3 >> 6) & 0x3Fu));
					bytes[num2++] = (byte)(0x80u | (num3 & 0x3Fu));
					continue;
				}
				if (num2 + 4 > num)
				...
				bytes[num2++] = (byte)(0xF0u | (num3 >> 18));
				bytes[num2++] = (byte)(0x80u | ((num3 >> 12) & 0x3Fu));
				bytes[num2++] = (byte)(0x80u | ((num3 >> 6) & 0x3Fu));
				bytes[num2++] = (byte)(0x80u | (num3 & 0x3Fu));
			}
		...
		{
			UnixEncoding unixEncoding = value as UnixEncoding;
			if (unixEncoding != null)
			{
				return true;
			}
			return false;
