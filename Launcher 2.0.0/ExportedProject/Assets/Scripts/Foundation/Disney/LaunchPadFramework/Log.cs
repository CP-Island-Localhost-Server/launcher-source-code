...
namespace Disney.LaunchPadFramework
{
	public class Log
	{
		...
		private void logException(object objectToLog, Exception e)
		{
			UnityEngine.Debug.LogException(e, objectToLog as UnityEngine.Object);
		}
