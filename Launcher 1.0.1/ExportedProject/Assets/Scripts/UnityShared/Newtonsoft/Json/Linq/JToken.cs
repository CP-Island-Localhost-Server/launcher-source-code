...
namespace Newtonsoft.Json.Linq
{
	public abstract class JToken : IJEnumerable<JToken>, IEnumerable<JToken>, IEnumerable, IJsonLineInfo, ICloneable
	{
		...
		public static explicit operator ushort?(JToken value)
		{
			...
			return (jValue.Value != null) ? new ushort?((ushort)Convert.ToInt16(jValue.Value, CultureInfo.InvariantCulture)) : null;
		}
		...
		{
			return _lineNumber.HasValue && _linePosition.HasValue;
		}
