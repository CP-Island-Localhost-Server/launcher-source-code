...
namespace Disney.Kelowna.Common.Tests
{
	public class BundleMount_DependenciesCreate_Test : BaseContentIntegrationTest
	{
		protected override IEnumerator runTest()
		{
			...
			BundleMount bundleMount2 = loadAndMount("DependencyBundlesTest/dep1.unity3d", new HashSet<BundleMount> { bundleMount }, true);
			BundleMount bundleMount3 = loadAndMount("DependencyBundlesTest/dep2.unity3d", new HashSet<BundleMount> { bundleMount2, bundleMount }, true);
