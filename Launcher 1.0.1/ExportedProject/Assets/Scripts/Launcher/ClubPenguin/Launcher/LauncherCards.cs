...
namespace ClubPenguin.Launcher
{
	public class LauncherCards : MonoBehaviour
	{
		...
		public GameObject UpdateCardPrefab;
		...
		{
			foreach (Transform item in LauncherCardsContainer.transform)
			{
				Object.Destroy(item.gameObject);
			}
			GameObject gameObject = Object.Instantiate(UpdateCardPrefab.gameObject, LauncherCardsContainer.transform);
			SliderTweener component = gameObject.GetComponent<SliderTweener>();
			component.StartsVisible = true;
		}
		...
		public void InitializeCards(CardsResponse cardsResponse)
		{
			...
			{
				GameObject gameObject = Object.Instantiate(LauncherCardPrefab.gameObject, LauncherCardsContainer.transform);
