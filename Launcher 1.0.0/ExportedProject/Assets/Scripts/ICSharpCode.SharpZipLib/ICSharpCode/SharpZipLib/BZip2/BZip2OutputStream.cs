				...
				while (num6 < nMTF)
				{
					...
					if (num3 == 6)
					{
						...
						for (int num21 = num6; num21 <= num8; num21++)
						{
							...
							num20 += (short)array[0][num22];
							num19 += (short)array[1][num22];
							num18 += (short)array[2][num22];
							num17 += (short)array[3][num22];
							num16 += (short)array[4][num22];
							num15 += (short)array[5][num22];
						}
						array4[0] = num20;
						array4[1] = num19;
						array4[2] = num18;
