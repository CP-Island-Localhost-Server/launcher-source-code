...
namespace Disney.Kelowna.Common
{
	public class GcsAccessTokenService : IGcsAccessTokenService
	{
		...
		private IEnumerator GetOAuthRequest()
		{
			...
			WWW www = new WWW(headers: new Dictionary<string, string> { { "Content-Type", "application/x-www-form-urlencoded" } }, url: "https://www.googleapis.com/oauth2/v4/token", postData: form.data);
			yield return www;
