...
namespace Disney.Kelowna.Common
{
	public class Performance
	{
		...
		public class Metric<T> : IMetric, IJsonSerializable where T : struct, IComparable, IComparable<T>, IConvertible, IEquatable<T>, IFormattable
		{
			...
			public double ExpMovingAverage { get; private set; }
			...
			public void UpdateValueIncremental(T next)
			{
				if (defaults)
				{
					double expMovingAverage = (Average = ConvertTo<double>(next));
		...
		public Metric<float> FrameTime { get; private set; }

		public Metric<float> FramesPerSecond { get; private set; }
		...
		public int SystemMemoryLimit { get; private set; }

		public Metric<long> CodeMemoryUsed { get; private set; }

		public Metric<long> CodeMemoryFree { get; private set; }

		public Metric<int> MonoMemoryReserved { get; private set; }

		public Metric<int> MeshMemory { get; private set; }

		public Metric<int> TextureMemory { get; private set; }

		public Metric<int> AudioMemory { get; private set; }

		public Metric<int> AnimationMemory { get; private set; }

		public Metric<int> MaterialsMemory { get; private set; }

		public Metric<int> OtherAssetMemory { get; private set; }

		public Metric<int> AssetMemory { get; private set; }

		public Metric<int> AssetCount { get; private set; }

		public Metric<int> TextureCount { get; private set; }

		public Metric<long> TotalMemoryUsed { get; private set; }

		public Metric<ulong> ProcessUsedBytes { get; private set; }
		...
		public bool SaveZoneUpdates { get; set; }
		...
		public static void EnsureFilePathExists(string filepath)
		{
			...
			string text = ((num != -1) ? filepath.Substring(0, num) : filepath);
